    ...
    return (
        ...
        <div className="banner_inner overlay d-flex align-items-center">
            ...
            <div className="banner_content text-left">
                <div className="page_link"> <a href="index.html">Home</a> <a href="#">Privacy Policy</a> </div>
            ...
            <div id="about">
                <div className="container">
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to HunKa Desarrollo Humano SC, Ures 93, Ciudad de México, México.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to HunKa, accessible from <a href="https://hunka.mx/" rel="external nofollow noopener noreferrer" target="_blank">https://hunka.mx/</a></p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>By email: omiquel@hunka.mx</li>
                    </ul>
